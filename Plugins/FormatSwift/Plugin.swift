...
struct SwiftFormatPlugin {
    func performCommand(context: CommandContext, inputPaths: [String], arguments: [String]) throws {
...
extension SwiftFormatPlugin: CommandPlugin {
    ...
    private func inputPaths(for package: Package) throws -> [String] {
        let url = URL(fileURLWithPath: package.directory.string)
        let packageDirectoryContents = try FileManager.default
